...
| `--include_channels`  | `-` | ""           | Only process the members who are in the provided channels. If not specified, tries to retrieve all server members if you have the appropriate permissions, otherwise attempts to scrape the member sidebar.                                                                                                                                                   | `--include_servers 'channel-1' channel-2'' 'channel-3'` |
